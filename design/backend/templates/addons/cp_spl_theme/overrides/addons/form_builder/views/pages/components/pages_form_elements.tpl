...
<div class="table-wrapper">
    <table class="table hidden-inputs table--relative">
    <thead>
        <tr>
    ...
    <tr>
        ...
        <td>
            ...
            <hr id="hr_elm_{$element.element_id}" width="100%" {if $element.element_type != $smarty.const.FORM_SEPARATOR}class="hidden"{/if} />
            <input id="note_elm_{$element.element_id}" class="cp-input-note{if $element.element_type == $smarty.const.FORM_SEPARATOR} hidden{/if}" placeholder="{__("note")}" type="text" name="page_data[form][elements_data][{$num}][note]" value="{$element.note}" />
        </td>
        <td>
