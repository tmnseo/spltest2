...
<div id="location_properties_{$html_id}">
    ...
    <div class="cm-tabs-content" id="tabs_content_location_{$html_id}">
		...
		<div class="control-group">
	            <label for="scroll_pagination" class="control-label">{__("scroll_pagination")} </label>
	            <div class="controls">
	                <input type="hidden" name="location_data[scroll_pagination]" value="N">
	                <input type="checkbox" name="location_data[scroll_pagination]" value="Y" id="scroll_pagination" {if $location.scroll_pagination=="Y"}checked="checked"{/if}>
	            </div>
               </div>
        </div>
        {if $dynamic_object_scheme}
