    ...
    {if $order_info}
        ...
        {capture name="order_actions"}
            {if $view_only != "Y"}
                <div class="ty-orders__actions">
                    {if $order_info.cp_confirm_status == 'Y'}
        ...
        {capture name="group"}
            ...
            <div class="ty-orders-summary clearfix">
                {include file="common/subheader.tpl" title=__("cp_order_info_title")}
                ...
                <div class="ty-orders-summary__wrapper">
                    <table class="ty-orders-summary__table">
                        {hook name="orders:totals"}
                            ...
                            {/if}
                            <tr>
                                <td>{__("cp_planned_time_issuing_order")}:</td>
                                <td>
                                {if $order_info.cp_planned_time_issuing_order}
                                    {$order_info.cp_planned_time_issuing_order|date_format:"`$settings.Appearance.date_format`"}
                                {/if}
                                </td>
                            </tr>
