...
<table class="ty-table ty-orders-search">
    <thead>
        <tr>
            ...
            <th class="hidden"><a class="{$ajax_class}" href="{"`$c_url`&sort_by=tracking_number&sort_order=`$search.sort_order_rev`"|fn_url}" data-ca-target-id="pagination_contents">{__("tracking_number")}</a>{if $search.sort_by == "tracking_number"}{$sort_sign nofilter}{/if}</th>
        </tr>
    </thead>
        ...
        <tr>
            ...
            <td class="ty-orders-search__item ty-orders-search__item--actions">
                ...
                {include file="buttons/button.tpl"
                        but_meta="ty-btn-icon"
                        but_role="text"
                        but_title=__("order_pretension")
                        but_href="order_pretension.new?order_id=`$o.order_id`"
                        but_icon="ty-orders__actions-icon ty-icon-doc-text"}
            </td>
            <td class="hidden ty-orders-search__item">{$o.tracking_number}</td>
        </tr>
    {foreachelse}
