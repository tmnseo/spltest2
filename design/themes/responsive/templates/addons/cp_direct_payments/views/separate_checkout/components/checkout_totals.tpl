{if $location == "cart" && $cart.shipping_required == true && $settings.Checkout.estimate_shipping_cost == "Y"}
    ...
    >
        <div class="ty-cart-content__estimation">
            {include file="addons/cp_direct_payments/views/separate_checkout/components/shipping_estimation.tpl"
                     vendor_id=$vendor_id
...
<div class="ty-cart-total">
    <div class="ty-cart-total__wrapper clearfix cm-reload" id="checkout_totals{$suffix_key}">
        {if $cart_products}
            <div class="ty-coupons__container">
                {include file="addons/cp_direct_payments/views/separate_checkout/components/promotion_coupon.tpl"}
        ...
        {include file="views/checkout/components/checkout_totals_info.tpl"  cart=$cp_global_cart_values }
        ...
        <ul class="ty-cart-statistic__total-list">
            <li class="ty-cart-statistic__item ty-cart-statistic__total">
                ...
                <span class="ty-cart-statistic__total-value">{include file="common/price.tpl" value=$carts_total|default:$smarty.capture._total|default:$cart.total span_id="cart_total" class="ty-price"}</span>
            </li>
        </ul>
