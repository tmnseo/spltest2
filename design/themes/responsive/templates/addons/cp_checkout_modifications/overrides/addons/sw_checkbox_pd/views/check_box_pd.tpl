...
{if $option == "call_request"}
    {if $addons.sw_checkbox_pd.check_call_requests == "Y" && !$product}
        <div class="ty-control-group sw-check_pd cm-field-container">
...
{if $option == "newsletters" && $addons.sw_checkbox_pd.check_subscr == "Y"}
    <div class="ty-control-group sw-check_pd pd-newsletters cm-field-container">
...
{if $option == "discussion" && $addons.sw_checkbox_pd.check_discuss == "Y"}
    <div class="ty-control-group sw-check_pd pd-discussion cm-field-container">
...
{if $option == "account_info" && $addons.sw_checkbox_pd.check_registration == "Y"}
    <div class="ty-control-group sw-check_pd pd-account_info cm-field-container">
...
{if $option == "checkout" && $addons.sw_checkbox_pd.check_checkout == "Y"}
    <div class="ty-control-group sw-check_pd pd-checkout cm-field-container">
...
{if $option == "page_form" && $page.check_form_pd == "Y"}
    <div class="ty-control-group sw-check_pd pd-page_form cm-field-container">
...
{if "MULTIVENDOR"|fn_allowed_for}
    ...
    {if $option == "reg_vendor" && $addons.sw_checkbox_pd.check_reg_vendor == "Y"}
        <div class="ty-control-group sw-check_pd pd-reg_vendor cm-field-container">
