    ...
    <div class="ty-nowrap" id="file_uploader_{$id_var_name}">
        ...
        <div class="ty-fileuploader__file-link {if $multiupload != "Y" && $images}hidden{/if}" id="link_container_{$id_var_name}">
            ...
            <div class="ty-fileuploader__file-local upload-file-local">
                ...
                <a data-ca-multi="Y" {if !$images}class="ty-btn ty-btn__tertiary ty-btn__fileuploader hidden"{/if}>{$upload_another_file_text|default:__("upload_another_file")}</a>
                <a data-ca-target-id="local_{$id_var_name}" data-ca-multi="N" class="ty-btn ty-btn__tertiary ty-btn__fileuploader ty-fileuploader__a{if $images} hidden{/if}">{$upload_file_text|default:__("upload_file")}</a>
            </div>
