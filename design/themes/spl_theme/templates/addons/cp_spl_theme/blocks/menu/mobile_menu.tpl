                        ...
                        {if $menu.subitems}
                             <ul class="cp-mobile-menu__subitems">
                                {foreach from=$menu.subitems item="subitems"}
                                    {if $subitems.class !== "cp-support-phone_menu"}
                                    ...
                                    {else}
                                        {if $subitems.href}
                                            {$cp_support_phone_href=$subitems.href|replace:' ':''}
                                        {/if}
                                        <li class="cp-mobile-menu__item-item{if $subitems.active} active{/if}{if $subitems.class} {$subitems.class}{/if}">
                                            <span class="cp-mobile-menu__a">
                                                {$subitems.item} 
                                                <a class="cp-mobile-menu__a_link" {if $subitems.href}href="tel:{$cp_support_phone_href}"{/if}> {$subitems.href}</a> 
                                            </span> 
                                        </li>
                                    {/if}
                                {/foreach}
