...
{else}
    {capture name="tabsbox"}
        <div class="ty-profile-field ty-account-user form-wrap" id="content_general">
            <form name="profile_form" enctype="multipart/form-data" action="{""|fn_url}" method="post">
                <input id="selected_section" type="hidden" value="general" name="selected_section"/>
                <input id="default_card_id" type="hidden" value="" name="default_cc"/>
                <input type="hidden" name="profile_id" value="{$user_data.profile_id}" />
                ...
                {capture name="group"}
                    <div class="ty-account-user__section ty-account-user__login-details">
                    ...
                    <div class="ty-account-user__section ty-account-user__contact_person">
                        {include file="views/profiles/components/profile_fields.tpl" 
                            section="C" 
                            title=__("contact_person") 
                            exclude=fn_cp_checkout_modifications_get_exclude_fields_by_section($profile_fields, $smarty.const.CP_SECTION_CONTACT_INFO)
                            hide_clearfix=true
                        }
                    </div>
                    ...
                    {if $profile_fields.B || $profile_fields.S}
                        ...
                        {else}
                            ...
                            {assign var="body_id" value="ba"}
                        {/if}
                        <div class="ty-account-user__section ty-account-user__company">
                            {include file="views/profiles/components/profile_fields.tpl" 
                                hide_clearfix=true
                                show_hint=true
                                text_hint=__("cp_inn_hint_profiles")
                                section="C"  
                                cp_add_disabled=true
                                title=__("cp_company_information") 
                                body_id="" 
                                exclude=fn_cp_checkout_modifications_get_exclude_fields_by_section($profile_fields, $smarty.const.CP_SECTION_COMPANY_INFO)
                            }
                            {include file="views/profiles/components/profile_fields.tpl" 
                            ...
                            {include file="views/profiles/components/profile_fields.tpl" 
                                ...
                                actual_same_as_billing=true
                                hide_clearfix=true
                                grid_wrap="actual_address"
                            }
                        </div>

                        <div class="ty-account-user__section ty-account-user__addition-company">
                            {include file="views/profiles/components/profile_fields.tpl" 
                                section="C" 
                                title=__("cp_addition_company_info") 
                                exclude=fn_cp_checkout_modifications_get_exclude_fields_by_section($profile_fields, $smarty.const.CP_SECTION_ADDITION_INFO)
                                hide_clearfix=true
                                grid_wrap="addition-company-info"
                            }
                        </div>
                    {/if}
                ...
                <div class="ty-profile-field__buttons  ty-account-user__buttons-container">
                    {include file="buttons/save.tpl" but_name="dispatch[{$dispatch}]" but_meta="ty-btn__secondary" but_id="save_profile_but" but_text=__("save_changes")}
                    <input class="ty-profile-field__reset ty-btn ty-btn__tertiary hidden" type="reset" name="reset" value="{__("revert")}" id="shipping_address_reset"/>
