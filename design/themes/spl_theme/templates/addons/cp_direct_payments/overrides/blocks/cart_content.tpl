                                        ...
                                        {foreach from=$_cart_products key="key" item="product" name="cart_products"}
                                            ...
                                            {if !$product.extra.parent}
                                                <li class="ty-minicart__item">
                                                    ...
                                                    <a class="ty-minicart__item-link" href="{"products.view?product_id=`$product.product_id`"|fn_url}">
                                                        ...
                                                        <div class="ty-minicart__item-desc">
                                                            <span class="ty-minicart__item-name">
                                                        ...
                                                        <div class="ty-minicart__item-info-price">
                                                            ...
                                                            <div class="ty-minicart__item-price">
                                                                ...
                                                                <span class="ty-minicart__item-display-price">
                                                                    <span class="ty-price_real{if $product.base_price > $product.price} discount{/if}">
                                                                        {include file="common/price.tpl" value=$product.display_price span_id="price_`$key`_`$dropdown_id`" class="ty-nowrap"}/{__("items")}
                                                                    </span>
                                                                    {if $product.base_price > $product.price}
                                                                        <span class="ty-price_old">
                                                                            {include file="common/price.tpl" value=$product.base_price class="ty-list-price"}/{__("items")}
                                                                        </span>
                                                                    {/if}
                                                                </span>
                                                            </div>
                        ...
                        <div class="cm-cart-buttons ty-cart-content__buttons{if $cart.amount} full-cart{else} hidden{/if}">
                            ...
                            <div class="ty-minicart__total">
                                <div class="ty-minicart__total-sum">
                                    ...
                                    {__("total")}{if $cart.taxes && $settings.Appearance.cart_prices_w_taxes == "Y"} {__("cp_spl_theme.including_tax")}{/if}:
                                    </span>
