<div class="ty-discussion-post-popup{if $meta} {$meta}{/if}" id="new_post_dialog_{$obj_prefix}{$obj_id}" title="{$new_post_title}">
    <div class="new-post__banner">
        <img src="images/banner/sofi2.png" width="391" height="247">
    </div>
    <h2 class="new-post__title">{__("leave_a_review")}</h2>
...
<div class="ty-control-group">
    ...
    <label for="{$rate_id}" class="ty-control-group__title cm-required cm-multiple-radios hidden">{__("your_rating")}</label>
...
<div class="ty-control-group">
    <label for="dsc_message_{$obj_prefix}{$obj_id}" class="ty-control-group__title cm-required hidden">{__("your_message")}</label>
