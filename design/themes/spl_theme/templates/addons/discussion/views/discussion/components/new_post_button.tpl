...
{if !$auth.user_id
    ...
    {$but_href = fn_url("discussion.cp_discussion_login_form?return_url=`$return_url|urlencode`")}
    ...
    {else}
        ...
        {include
            ...
            but_meta="cm-dialog-opener cm-dialog-auto-size ty-btn__secondary ty-btn__new-post"
            but_rel="nofollow"
        }
    {/if}
{else}
    ...
    {else}
        {include
            ...
            but_meta="cm-dialog-opener cm-dialog-auto-size ty-btn__secondary ty-btn__new-post"
            but_rel="nofollow"
            but_dialog_class="new-post__popup"
        }
    {/if}
{/if}
