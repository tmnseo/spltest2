<h2 class="itecheckout__shipping-title">{$block.name}</h2>

<div class="litecheckout__group litecheckout_city">
{include file="views/checkout/components/profile_fields/s_city_autocomplete.tpl" }
