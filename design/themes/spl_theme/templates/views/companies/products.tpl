...
<div id="products_search_{$block.block_id}">
    ...
    {if $products}
        ...
        {if $layouts.$selected_layout.template}
            <div class="cp-vendor-products" id="category_products_{$block.block_id}">
...
{capture name="mainbox_title"}
    <span class="ty-mainbox-title__left hidden">{$_title}</span>
    <span class="ty-mainbox-title__right hidden" id="products_search_total_found_{$block.block_id}">{$title_extra nofilter}<!--products_search_total_found_{$block.block_id}--></span>
{/capture}
{/hook}