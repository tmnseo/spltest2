...
<div class="litecheckout litecheckout__form" id="litecheckout_form">
    ...
    <div data-ca-lite-checkout-element="form">
        ...
        >
            ...
            >
            <div
                class="litecheckout__group litecheckout__multiple-orders"
            ...
            <div class="litecheckout__group litecheckout__submit-order  litecheckout__multiple-orders" id="litecheckout_final_section">
