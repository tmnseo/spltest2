...
{/if} *}
<div id="scroll_list_{$block.block_id}" class="ty-scroller-list{if !$items.exist_images} ty-scroller-list_no-img{/if}">
        ...
        {if $product.product_id}
            ...
            <div class="ty-scroller-list__item">
                ...
                <div class="ty-scroller-list__img-block">
                    ...
                    <a href="{"products.view?product_id=`$product.product_id`&warehouse_id=`$product.best_warehouse_id`"|fn_url}">{$object_img nofilter}</a>
                    {if $settings.Appearance.enable_quick_view == "Y" && $block.properties.enable_quick_view == "Y"}
                ...
                <div class="ty-scroller-list__description">
                    {strip}
                        {include file="blocks/list_templates/simple_list.tpl" product=$product show_name=true show_price=true show_add_to_cart=$_show_add_to_cart show_list_buttons=$_show_add_to_cart but_role="action" hide_price=$_hide_price hide_qty=true show_product_labels=true show_discount_label=true show_shipping_label=true}
                    {/strip}
                </div>
            </div>
            {/hook}
...
{include file="common/scroller_init_slick.tpl"}
