...
class Service
{
     ...
     */
    public function __construct(ProductRepository $product_repository, ProductIdMap $product_id_map, callable $sync_schema_factory, callable $copy_schema_factory)
    {
