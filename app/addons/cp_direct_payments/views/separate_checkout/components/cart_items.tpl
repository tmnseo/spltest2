...
{/if}
    ...
    <div class="cp-cart-vendor__header clearfix">
        <div class="cp-cart-vendor__header_left cm-combination open" id="sw_cart_items{$suffix_key}">
            ...
            <div class="cp-cart-vendor__warehouse">
                {__("cp_checkout_modifications_warehouse")}: <strong>{$location_warehouse.pickup_address}</strong>
            </div>
    ...
    <thead>
        <tr>
            <th class="ty-cart-content__title product ty-left"><span>{__("product")}</span></th>
            <th class="ty-cart-content__title ty-left"><span>&nbsp;</span></th>
            <th class="ty-cart-content__title ty-right cp-hidden-tablet" ><span>{__("cp_checkout_modifications_manufacturer")}</span></th>
            <th class="ty-cart-content__title ty-right cp-hidden-tablet"><span>{__("cp_checkout_modifications_manufacturer_code")}</span></th>
            <th class="ty-cart-content__title ty-right"><span>{__("unit_price")}</span></th>
            <th class="ty-cart-content__title quantity-cell"><span>{__("quantity")}</span></th>
            <th class="ty-cart-content__title total-price ty-right"><span>{__("total_price")}</span></th>
        </tr>
    </thead>
            ...
            {hook name="checkout:items_list"}
                ...
                {if !$cart.products.$key.extra.parent}
                    <tr>
                        ...
                        <td class="ty-cart-content__product-elem ty-cart-content__description" {*style="width: 40%;"*} width="40%">
                            {strip}
                        ...
                        <td class="ty-cart-content__product-elem cp-hidden-tablet">
