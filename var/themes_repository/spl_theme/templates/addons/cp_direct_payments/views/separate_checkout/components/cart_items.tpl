...
{/if}
        ...
        <div class="cp-cart-vendor__header_right">
            ...
            {if $payment_methods}
                ...
                {include file="buttons/proceed_to_checkout.tpl"
                    ...
                    but_text=__("place_in_one_order")
                }
            {/if}
            {include file="buttons/button.tpl" 
    ...
    <thead>
        <tr>
            ...
            <th class="ty-cart-content__title unit_price" style="width: 140px"><span>{__("unit_price")}</span></th>
            <th class="ty-cart-content__title quantity-cell" style="width: 120px"><span>{__("quantity")}</span></th>
