    ...
    <div class="ty-geo-maps-confirm">
        <div class="ty-geo-maps-confirm__container">
            <div class="ty-geo-maps-confirm__header">
                <div class="ty-geo-maps-confirm__title">{__("addons.cp_geo_maps_ext.title")}</div>
                <div class="ty-geo-maps-confirm__city">{$location.city}</div>
            </div>
            <div class="ty-geo-maps-confirm__buttons">
                <a><span class="ty-geo-maps-confirm__yes">
                ...
                {include file="addons/cp_geo_maps_ext/common/popup_open_link.tpl"
                         ...
                         link_text_meta="ty-geo-maps-confirm__no"
                         link_meta=""
