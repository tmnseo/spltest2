        ...
        <div class="ty-profile-field ty-account form-wrap" id="content_general">
            <form name="profile_form" enctype="multipart/form-data" action="{""|fn_url}" method="post">
                ...
                {capture name="group"}
                    ...
                    {*include file="views/profiles/components/profile_fields.tpl" section="C" title=__("contact_information") exclude=fn_cp_checkout_modifications_get_exclude_fields($profile_fields)*}
                    ...
                    {include file="views/profiles/components/profile_fields.tpl" section="C" title=__("cp_company_information") exclude=fn_cp_checkout_modifications_get_exclude_fields_by_section($profile_fields, $smarty.const.CP_SECTION_COMPANY_INFO)}
                    {*CP: end *}
                    ...
                    {if $profile_fields.B || $profile_fields.S}
                        ...
                        {*include file="views/profiles/components/profile_fields.tpl" section="C" title=__("cp_addition_company_info") cp_addition_company_info=true exclude=fn_cp_checkout_modifications_get_exclude_fields($profile_fields, true)*}
