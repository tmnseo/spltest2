    ...
    {if $original_products || $analog_products}
        ...
        <div id="products_search_original_{$block.block_id}">
            ...
            <h3 class="ty-mainbox-title">
                ...
                <span class="ty-mainbox-title__left">{__("addons.cp_catalog_changes.original_search_results")}</span><span class="ty-mainbox-title__right" id="products_search_original_total_found_{$block.block_id}">{$title_extra nofilter}<!--products_search_original_total_found_{$block.block_id}--></span>
                {/hook}
            </h3>
            {if $original_products}
