...
function fn_calculate_total_shipping_cost(is_hidden)
{
    ...
    /**
     * Cart Power
     * Solution to the problem - when choosing a pickup point from the list, after updating by ajax, the list is reset to the top
    **/
    var topBlock = $('.litecheckout__shipping-address').scrollTop();
    /*end of modification Cart Power*/
    ...
    Tygh.$.ceAjax('request', url,  {
        ...
        callback: function (response) {
             ...
             * Solution to the problem - when choosing a pickup point from the list, after updating by ajax, the list is reset to the top
            **/
            $('.litecheckout__shipping-address').scrollTop(topBlock);
            /*end of modification Cart Power*/
        }
    });
}
