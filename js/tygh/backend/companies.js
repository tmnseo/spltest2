(function (_, $) {
    ...
    var fn_switch_storefront_status = function (request_data, url) {
        ...
        //original request_data['result_ids'] = 'header_subnav,header_navbar,actions_panel,storefront_url_*'
        
        request_data['result_ids'] = 'header_subnav,header_navbar,actions_panel,storefront_url_*,cp_totals_table,cp_statuses_content';
