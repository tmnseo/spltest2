(function (_, $) {
    var yandex = {
        ...
        _addMarkersToCluster: function ($container, markers) {
            ...
            // start of change Cart-Power  -  Open balloon on the map
            if ($container.hasClass('pickup__map-container')) {
                map_marker.balloon.open(map);
            }
            // утв of change Cart-Power  -  Open balloon on the map
        },
